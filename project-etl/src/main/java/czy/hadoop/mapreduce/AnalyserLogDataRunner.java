...
import czy.hadoop.common.GlobalConstants;
...
public class AnalyserLogDataRunner implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        //TableMapReduceUtil.initTableReducerJob(Constant.HBASE_NAME_EVENT_LOGS, null, job);
        // 2. 本地运行，要求参数addDependencyJars为false
        TableMapReduceUtil.initTableReducerJob(Constant.HBASE_NAME_EVENT_LOGS, null, job, null, null, null, null, false);
    ...
    private void setJobInputPaths(Job job) {
        ...
        try {
            ...
            Path inPath = new Path("/logs/" + TimeUtil.parseLong2String(TimeUtil.parseString2Long(date), "MM/dd/"));
